...
> · 🔴 **งานออกแบบใหม่จาก P1: ทะเบียนคำถามเปิด `Q<n>`** — รากของ `D71` (คำถามเปิดไม่มี ID/สถานะ/ที่อยู่ทางการ ต่างจาก `D<n>` ที่มีแค่ฝั่งคำตอบ) ดูข้อเสนอที่ [`§9`](#9--ข้อเสนอ-ทะเบียนคำถามเปิด-qn) ท้ายไฟล์ · P6 รอต่อท่อ CI guard จากดีไซน์นี้
...
9. [ข้อเสนอ — ทะเบียนคำถามเปิด (Q\<n\>)](#9--ข้อเสนอ-ทะเบียนคำถามเปิด-qn)
...
## 9 — ข้อเสนอ: ทะเบียนคำถามเปิด (Q\<n\>)
...
> **ข้อนี้เป็นข้อเสนอเหมือนทุกข้อในไฟล์นี้ — รอ P1 ตัดสินก่อนย้ายเข้า `README.md`** (ที่ซึ่ง `D<n>` อยู่แล้ว และเป็นที่เดียวที่เลขข้ามไฟล์ใช้ได้จริงตามกติกาเลขที่ P1 ตั้งไว้)
...
|---|---|---|---|---|
| Q14 | 24 ส.ค. · P8 | คำเชิญส่งถึงคนที่ถูกเชิญยังไง | `backlog.md §8 ข้อ 10` | ✅ ปิดด้วย `D68` |
| Q17 | 25 ส.ค. · P8 | ตารางอื่นใน `column-map.md` มี `P-51` ซ่อนอยู่อีกไหม | `backlog.md §4 E2-AC11` | 🔴 เปิด |
