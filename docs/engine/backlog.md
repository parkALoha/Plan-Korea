...
> | **P3** | **`E5-AC1`/`AC2` — `/trip/[tripId]`** | เริ่มได้ทันที · route ฝั่งเซิร์ฟเวอร์ 11 เส้นรับ `tripId` รออยู่แล้ว |
> | **P4** | `E3-AC9` เมทริกซ์ข้ามผู้ใช้ระดับ route (11 เส้น) · `E3-AC8` static guard | สเปคส่งแล้ว |
...
> · `E3-AC9` ยังเปิดอยู่ เหลือ 10 เส้นให้ P4 ยิงต่อ
>
