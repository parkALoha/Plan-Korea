...
- [ ] **E5-AC3** 🔴 **เกณฑ์ห้ามถอยหลังของทริปจริง:** เปิดทริปเกาหลีบนแพลตฟอร์มใหม่แล้ว **ทั้ง 11 วัน (11–21 ต.ค.) แสดงครบเท่าของเดิมทุกวัน** — จำนวนจุดแวะ · ที่พัก · ตั๋ว 8 ใบ · checklist ตรงกันทุกแถว
      📌 **ยังไม่ครบตามถ้อยคำ — มีหลักฐานบางส่วนเท่านั้น (P8 ตรวจ 27 ส.ค. 2026):** commit `1f442f8` เขียนว่า *"E5-AC3 checked live: the Korea trip renders identically to before extraction"* — นี่คือการเช็คว่า**การย้ายโค้ด (extract `HomeContent` → `TripPlanScreen`) ไม่ทำให้ของเดิมพัง** ไม่ใช่การไล่นับ 11 วัน/จุดแวะ/ตั๋ว 8 ใบ/checklist ตามที่ AC เขียนไว้เต็มรูป **ห้ามอ่านว่าเป็นหลักฐานปิด AC นี้** — ยังไม่มีใครวัดตามถ้อยคำวันนี้
      🔴 **แก้ 28 ส.ค. 2026 — มีหลักฐานเพิ่ม แต่ยังไม่ครบพอติ๊ก (P1):** ผู้ใช้รันคิวรีนับจริงบน prod แล้ว — **จุดแวะ 71 · วัน 11 · ที่พัก 4 · ตั๋ว 8 · checklist 8** ตรงกับของเดิมทุกจำนวน แต่ **นี่คือหลักฐานว่า *จำนวน* ตรง ไม่ใช่ว่า *เนื้อ* ตรง** (ชื่อสถานที่/เวลา/หมายเหตุรายแถวยังไม่มีใครเทียบ) — เกณฑ์เขียนไว้ว่า "ตรงกันทุกแถว" ซึ่งกว้างกว่าแค่นับแถว ยังปล่อย `[ ]` ตามเดิม
