...
- [ ] **DoD-9** 🔴 **เดิน flow ปลายทางจริง จากสถานะเริ่มต้นที่เป็นจริง — ไม่ใช่ตรวจว่าของที่เขียนไว้ถูก** (P1 ขอ 24 ส.ค. 2026 · ที่มาคือ `D44`)
...
> 🎯 **ถ้อยคำใหม่ที่ผมเสนอ — 🔴 `D26` เป็นเลขของ P1 จึงต้องให้ P1 รับรองก่อนถือว่าแทนของเดิม:**
...
> 🔴 **แก้ 24 ส.ค. 2026 (`D44`) — ประโยคนี้มีสมมติฐานที่ไม่จริงอยู่ข้างใน: มันสมมติว่ามีปุ่มเชิญ ซึ่งไม่มี**
> ### **"ก่อนเชิญคนที่ 3: ต้องเชิญได้จริง · ยืนยันว่า B2/B3/D12 ปิดแล้ว · และพ้น Hobby"**
> <sub>🔴 **`D26` เป็นเลขของ P1 — ถ้อยคำใหม่นี้รอ P1 รับรองก่อนถือว่าแทนของเดิมอย่างเป็นทางการ** · เหตุผลเต็มอยู่ที่ [`M2-INV`](#-m2-inv--ตารางคำเชิญ--flow-ยอมรับคำเชิญ)</sub>
