...
- [ ] **E6-AC4** offline อ่านอย่างเดียวยังใช้ได้จริงบน airplane mode ~~(ผู้ใช้ยืนยันเองแล้วครั้งหนึ่ง 13 ส.ค. 2026)~~
      ...
      | สมาชิกทริป | `useTripMembers` | 🟡 ถกได้ว่าต้องอ่านออฟไลน์ไหม |
      | ด่านวัน/legacy gate | `useTripDaysGate`/`useLegacyDayPlanGate` | 🟡 เป็นด่าน แคชแล้วอาจตอบผิดฝั่ง ต้องคิดทิศ fail-safe ก่อน |
