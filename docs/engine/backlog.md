...
· ทั้งคู่อ่านผ่านรีวิวได้ทุกครั้งเพราะสมเหตุสมผล เหมือนป้าย "ข้อยกเว้นที่ 4" ที่ถูกพิมพ์ใส่ 5 ตารางที่ข้อ 4 ไม่ได้ครอบ (`README.md`) — ไม่ใช่รูปแบบใหม่ แค่เกิดในคอมเมนต์โค้ดแทนที่จะเป็นเอกสาร
