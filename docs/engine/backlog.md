...
- [ ] **E5-AC9** 🔴 **ใหม่ 27 ส.ค. 2026 (สเปกผู้ใช้ผ่าน P1 · รอบแก้ที่ 65) — flow สร้างทริป 2 สเต็ป:** สเต็ป 1 ข้อมูลพื้นฐาน + เลือกประเทศ/เมืองปลายทาง (จุดหมาย + รูปปก บันทึกตรงนี้) · สเต็ป 2 เชิญเพื่อน — **ต้องข้ามได้** (ผู้ใช้ตัดสินเลื่อนคำเชิญทั้งก้อนออกไป) ปุ่มเชิญจริงยังปิดตาม `D26.1`/`M2-INV` เหมือนเดิมทุกตัวอักษร ไม่ใช่ทางลัดใหม่
      ...
      · 🔴 **บล็อกจริง — schema `trips` ยังไม่มีคอลัมน์จุดหมาย/รูปปก** ส่งต่อ P1 (โซน E2/schema) ก่อนเริ่มเขียน form ได้จริง — ไม่ใช่งาน UI ล้วน
      🔴 **แก้ 27 ส.ค. 2026 (P8 ตรวจโค้ดจริง — ยังไม่ครบตามถ้อยคำ "2 สเต็ป" อย่าติ๊ก):** `components/CreateTripForm.tsx` เป็น**ฟอร์มเดียวจบ** — ชื่อ/วันที่/`TripDestinationPicker`/ปุ่มสร้าง อยู่หน้าเดียวกันหมด **ไม่มีสเต็ป 2 (เชิญเพื่อน) อยู่เลยในโค้ด ไม่ใช่มีแต่ซ่อน/ข้ามได้** — สอดคล้องกับการตัดสินใจเลื่อนคำเชิญ (ถูกต้องที่ยังไม่สร้าง) แต่แปลว่า**โครง "2 สเต็ป" ตามตัวอักษรของ AC ยังไม่มีอยู่จริง** เป็นฟอร์ม 1 สเต็ปที่ครบเฉพาะครึ่งแรก ไม่ใช่ 2 สเต็ปที่ข้ามสเต็ปสองได้ — ส่งต่อ P1/P2: จะเขียน AC ใหม่ให้ตรงกับที่ตั้งใจจริง ("1 สเต็ป เพราะคำเชิญยังไม่สร้าง") หรือจะรอสร้างสเต็ป 2 จริงก่อนถึงจะปิดได้
