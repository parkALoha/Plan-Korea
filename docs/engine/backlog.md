...
- [ ] **E2-AC13** 🔴 **ใหม่ 24 ส.ค. 2026 — `bookings.file_url` ต้องเลิกเป็น URL ก่อนปิด bucket ไม่ใช่หลัง**
      ...
      **แก้ 25 ส.ค. 2026 — แยกสถานะ 3 ข้อของ AC นี้ให้ชัด (P1):**
      ...
      · **② เปิดไฟล์ตั๋วของแถวเดิมได้จริงจากในเว็บ หลังปิด bucket** — ✅ **ผลลัพธ์เป็นจริง เช็คบ็อกซ์ถูก แต่กลไกที่บันทึกไว้ผิด — แก้ 26 ส.ค. 2026 (P3 ตรวจเจอ · P1 เช็คซ้ำยืนยัน):**
        ...
        · 📌 **ชะตาของ `/api/booking-file/[...path]`:** ค้างไว้จนข้อเสนอใหม่ของ P3 สำหรับ ③ ลงจริง แล้วลบทิ้ง — **ระหว่างนี้คือโค้ดตายในโซน P1 ที่เป็นพื้นผิวโจมตีโดยไม่มีใครดู** (route รับ path parameter ที่ไม่เคยถูกทดสอบเพราะไม่เคยถูกเรียกจริง)
