...
- [ ] **E6-AC10** 🔴 **มินท์ใหม่ 28 ส.ค. 2026 (P3 เสนอทดแทน `AC1` · ส่งตรงถึง P8 ตามที่ P1 บอก) — หน้าที่ไม่ใช่ทริปเกาหลี ต้องไม่โหลดข้อมูลของทริปเกาหลี:**
      ...
      - [ ] **ทริปแพลตฟอร์ม (ญี่ปุ่น/ไทย/ฯลฯ)** 🔴 ยังไม่ผ่าน — วันนี้โหลด `data/*` ครบเพราะใช้ component ชุดเดียวกับทริปเกาหลี ผ่าน 4 ราก (`resolvePlace`/`hotelLegs`/`schedule`/`eventPlace`)
