...
- [ ] **E5-AC4** DnD ยังทำงานเหมือนเดิม (`hooks/useTripDnd.ts` + `@dnd-kit` ผ่านสนามจริงแล้ว **ห้ามเขียนใหม่**) — ลากในวัน · ลากข้ามวัน · ลากกลับคลัง ครบ 3 ท่า
      ...
      · [ ] **AC4b — ลากด้วยนิ้วจริง 3 ท่า:** 🔴 **คนเท่านั้น ไม่มีเครื่องมือในทีมทำได้** (ข้อจำกัดของ `dnd-kit` เอง ไม่ใช่ของทีม) — เปิดค้างไว้จนกว่าจะมีคนลากจริงบนอุปกรณ์จริง
      ...
      ⚠️ **`AC4a` เขียว ≠ `AC4` เสร็จ** — ไม่ติ๊กข้อแม่จนกว่า `AC4b` จะมีคนทำ
