...
P1 ตั้งข้อสังเกตว่า *"ของที่พังโดยไม่มีสัญญาณ คือสิ่งที่ทีมนี้เจอซ้ำที่สุดในวันนี้"* — ผมไล่นับแล้ว **ไม่ใช่ความรู้สึก มี 16 ตัวจริง** (10 → 14 ในวันเดียว · **15-16 เจอวันถัดมา และตัวที่ 15 เกิดขึ้นจริงแล้วภายในไม่กี่ชั่วโมงหลังผมเตือน**)
