...
- [ ] **E7-AC2** 🔴 **รายงาน diff เป็น 0 — เทียบกับสำเนาแช่แข็ง ไม่ใช่เทียบกับตัวเลขที่จดไว้**
      ...
      🔴 **ผลที่ต้องเขียนกำกับตรงๆ ไม่ปิดบัง:** การเทียบด้วยตัวเลขพิสูจน์ *จำนวน* ตรง ไม่ได้พิสูจน์ *เนื้อ* ตรงเหมือนสำเนาแช่แข็ง — **เกณฑ์ "checksum ของฟิลด์เนื้อหาตรงกัน" ด้านบนต้องทบทวนใหม่ตามข้อจำกัดนี้** ยังไม่ได้ตัดสินว่าจะยอมรับความเสี่ยงนี้ทั้งหมด หรือหาวิธี checksum ที่ไม่ต้องย้ายข้อมูลจริงออกจากฐานจริง (เช่น รันสคริปต์เทียบบนฐานจริงเองแล้วส่งออกแค่ตัวเลข/checksum ไม่ส่งแถว) — ส่งต่อ P1 ตัดสินแนวทาง ก่อนเริ่มเขียนสคริปต์ `E7-AC1`
