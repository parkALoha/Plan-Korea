...
- [ ] **E7-AC8** 🔴 **ด่านแรกสุด — ไม่ผ่านข้อนี้ ห้ามแตะ schema ของ DB ทริปแม้แต่คำสั่งเดียว (`D21`)**
      ...
      **① เลข 690 ผิด ปักไว้ที่ไฟล์ ไม่ใช่ฐานสด** — `/Users/park/trip-data.sql` มี **670 แถว** เลขเดิมเทียบไฟล์ตายกับฐานสดที่ยังเดินอยู่ ต่างกันได้เองโดยไม่มีอะไรผิด (3 ตารางแคชโตเองตลอดเวลา รูปเดียวกับ `E4-AC8` ที่โดนวันเดียวกัน 950→948) → **เกณฑ์นับแถวต้องเทียบกับไฟล์ dump ที่ตายแล้วเท่านั้น ไม่ใช่ฐานต้นทาง**
