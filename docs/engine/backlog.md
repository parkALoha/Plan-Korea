...
- [ ] **E4-AC7** 🔴 **ใหม่ 27 ส.ค. 2026 (P1 พบระหว่างวัด `AC8`/`AC4b` · ส่งให้ P8 — ขอบเขตประเทศเปลี่ยนวันนี้ เป็นของใหม่ ไม่ใช่ของเก่าที่ตกหล่น) — คลังสถานที่ต้องมีของจริงให้ครบ 4 ประเทศที่ผู้ใช้ประกาศรองรับ:** ผู้ใช้ตัดสิน 27 ส.ค. 2026 ว่ารองรับ **ไทย · ญี่ปุ่น · เกาหลี · เวียดนาม** เท่านี้ก่อน (เหตุผล: ชุดที่คนเดินทางไป-กลับจากไทยจริง จำนวนจำกัดพอดูแลครบได้)
      ...
      · **สถานะ: 3 ไฟล์ลงแล้ว (commit) รอผู้ใช้ `db:push` — P1 เป็นเจ้าของ seed ชุดนี้:**
        ...
        🔴 **แต่ยังห้ามติ๊ก** จนกว่าจะ push จริง + มีคนเปิดเว็บกดดู — ตอนนี้มีแค่ตัวเลขในบล็อกยืนยัน ยังไม่มีใครพิสูจน์ฝั่งบวก (P1 ระบุเองตรงๆ)
