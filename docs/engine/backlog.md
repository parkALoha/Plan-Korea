...
- [x] **E2-AC14** ✅ **ติ๊กแล้ว 26 ส.ค. 2026 — เนื้อในบอกว่าผ่านครบ 6 ตารางมาตั้งแต่ `D78` แต่ช่องค้างไว้ (P1 ชี้)** เดิม 🔴 **ใหม่ 24 ส.ค. 2026 — ครึ่งสคีมาของ `~~E1-AC5~~` ที่ย้ายมาจาก `E1` (`D58`)**
