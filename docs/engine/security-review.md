...
ไม่ใช่ยิง DB ทริปจริง** — ทำได้ทันทีที่ Docker ของ P6 ขึ้น ไม่ต้องรอ E1
...
## 8. ของที่ส่งต่อคนอื่น (P4 ไม่แก้เอง ตาม `TEAM.md`)
