...
> **ผลต่อขั้นนี้:** คำสั่งขั้น 3 ที่ใส่ `SUPABASE_ACCESS_TOKEN=` หน้าคำสั่ง **ยังถูกต้องและใช้ได้**
...
> ✅ **วิธีกัน:** วาง token ลงในคำสั่งตรงๆ อย่าผ่านตัวแปร · หรือรัน `supabase logout` ก่อนเริ่ม ให้ไม่มีอะไรให้ถอยกลับไปใช้
...
> ### 🔴 กับดักที่ต้องรู้ก่อนขั้น 3 — `link` ผูกกับ "ที่ที่คุณยืน" ไม่ใช่กับ repo
