...
> **จับได้ด้วยการอ่าน callback URL ก่อนกด Save** (P1 เห็นภาพหน้าจอที่ผู้ใช้ส่งมา แล้วให้กด Cancel)
> ช่อง Client ID ยังว่าง **ไม่มีอะไรลง DB ทริป** — แต่ห่างจาก Save แค่คลิกเดียว
...
> → เหตุการณ์วันนั้น **ไม่ใช่การถูกเด้งเพราะไม่มีสิทธิ์ แต่เป็นการไล่กดใน UI จากโปรเจกต์ที่ค้างอยู่**
> 🔴 **อย่าไปไล่แก้สิทธิ์บัญชีเบราว์เซอร์ — ไม่ใช่สาเหตุ** · สาเหตุคือ "เปิดหน้าถูก แต่ไม่ได้ดูว่าอยู่โปรเจกต์ไหน"
