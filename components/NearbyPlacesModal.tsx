  ...
  return (
    <>
      ...
      <Modal
        onClose={onClose}
        title={config.title}
        /* 🔴 **กล่องต้องนิ่งตั้งแต่เปิด** — ผู้ใช้เจอ 4 ก.ย. 2026: กดแล้วโมดัลเล็กก่อนแล้วค่อยขยาย
           ไม่ใช่แอนิเมชัน — มันคือ **ความสูงตามเนื้อหา**: ตอนโหลดมีแค่หัวข้อ + "กำลังค้นหา..." บรรทัดเดียว
           พอผลมาถึง ~10 แถวก็พุ่งไปชน `max-h-[90vh]` · และมันจะกระตุกอีกทุกครั้งที่พิมพ์ค้นหา
           เพราะจำนวนผลเปลี่ยน ⇒ โมดัลที่ *เรียกดูรายการ* ต้องมีความสูงพื้นคงที่ ไม่ใช่ยืดตามผลลัพธ์ */
        bodyClassName="pb-5"
        fillHeight
        headerExtra={
