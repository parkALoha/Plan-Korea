      ...
      <div className="mx-auto max-w-[110rem] px-4 pt-5">
        {state.status === "loading" ? (
          ...
          <>
            ...
            {/* 🔴 `scroll-mt-20` (80px) ไม่ใช่ค่าเล็ก ๆ — **แถบหัวเป็น `sticky top-0` สูง 63px** (วัดจากหน้าจริง)
                เผื่อน้อยกว่านั้น หัวข้อ "ทริปแนะนำ" จะไปมุดอยู่ *ใต้* แถบหัว ⇒ เลื่อนไปถูกที่แต่ผู้ใช้ไม่เห็นชื่อหัวข้อ
                🎯 ***ผู้ใช้ทักเองว่า "ควรเห็นข้อความ คำว่าทริปแนะนำด้วย"*** — เลื่อนถึงแล้วยังไม่พอ ต้องอ่านออกด้วย
                ⚠️ ฉบับแรกใช้ `scroll-mt-4` (16px) → เหลือระยะจากแถบหัวแค่ 23px · ตึงเกินไปและพังทันทีถ้าแถบสูงขึ้น */}
            <div ref={chooseRef} tabIndex={-1} className="scroll-mt-20 outline-none">
              <RecommendedTrips />
