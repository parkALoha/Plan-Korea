...
self.addEventListener("install", (event) => {
  // ไม่ precache หน้า HTML ไว้ล่วงหน้า — ด่าน PIN (เฟส 13.5) จะตอบ 307 ไป /unlock เมื่อยังไม่ปลดล็อก
  // แล้วเราจะเก็บหน้า unlock ไว้เป็นเนื้อหาของ /today ถาวร · ปล่อยให้หน้าเข้าแคชตอนเปิดจริงแทน
