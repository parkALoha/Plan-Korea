...
# 🔴 CommonMark: หัวข้อ ATX เยื้องได้ **0–3 ช่อง** · เยื้อง **4 ช่องขึ้นไป = code block ไม่ใช่หัวข้อ**
#    → ไม่มี anchor ให้ลิงก์ไปถึง · เจอของจริง 27 ส.ค. 2026 ที่ `backlog.md:905`
#      (`### \`P-78\`` เยื้อง 6 ช่อง — ในซอร์สดูเหมือนหัวข้อ แต่ GitHub เรนเดอร์เป็นบล็อกโค้ด)
#    ⚠️ ช่วง 1–3 ช่องสำคัญคนละทาง: มัน **เป็นหัวข้อจริงและมี anchor**
#      ถ้าเราไม่นับ จะไปฟ้องลิงก์ที่กดแล้วไปถูกที่ = ด่านโกหกในทิศที่ทำให้คนปิดมัน
#      วัดแล้ววันนี้ **0 บรรทัด** ที่เยื้อง 1–3 ช่อง — แก้ตอนฐานเป็นศูนย์ ไม่ต้องไล่เก็บของเก่า
