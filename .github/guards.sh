...
# ── ภาพปกต้องมาเป็น "คู่" เสมอ — ใบใหญ่ 800px + ใบเล็ก 400px (P5 เสนอ · P3 ยิงมัลแตนต์ยืนยัน 4 ทาง · P6 6 ก.ย. 2026) ──
...
# ✅ ยิง 5 ทิศเอง (ไม่ได้เชื่อรายงานเฉย ๆ): คู่ครบ=ผ่าน · ใบเล็กหาย=แดง · ใบเล็กกำพร้า=แดง ·
#    โฟลเดอร์ประเทศว่าง=ผ่าน · ไม่มี public/catalog เลย=ผ่าน — สองข้อหลังจำเป็น ไม่งั้นแดงใส่ทรีที่ยังไม่มีภาพ
