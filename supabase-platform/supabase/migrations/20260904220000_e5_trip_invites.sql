...
begin
  ...
  -- 🔴 256 บิตจาก `gen_random_uuid()` สองใบ — **ไม่พึ่ง pgcrypto**
  --    (ยิ่งพึ่ง extension น้อย ยิ่งมีที่ให้พังตอนย้ายฐานน้อย · และ `gen_random_uuid` เป็นของในคอร์แล้ว)
  --    ⚠️ **ห้ามทำให้สั้นลง** — `peek_trip_invite` เปิดชื่อทริปให้คนที่เดาโทเคนถูก
  --       ความปลอดภัยของข้อนั้น *คือ* ความยาวตรงนี้
