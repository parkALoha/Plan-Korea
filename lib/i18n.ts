...
export const E5_COPY = {
  ...
  tripCover: {
    title: "รูปปกทริป",
    noCover: "ยังไม่มีรูปปก",
    upload: "อัปโหลดรูปปก",
    replace: "เปลี่ยนรูปปก",
    remove: "ลบรูปปก",
    uploading: "กำลังอัปโหลด...",
    removing: "กำลังลบ...",
    readOnlyNote: "ระบบปิดรับการแก้ไขชั่วคราว — เปลี่ยนรูปปกตอนนี้ไม่ได้",
    errorType: "ไฟล์ต้องเป็น JPEG, PNG หรือ WebP เท่านั้น",
    errorSize: "ไฟล์ใหญ่เกิน 5MB",
    errorEmpty: "ไฟล์ว่าง — เลือกไฟล์ใหม่",
    errorAuth: "เซสชันหมดอายุ — เข้าสู่ระบบใหม่แล้วลองอีกครั้ง",
    errorForbidden: "เฉพาะเจ้าของทริปเปลี่ยนรูปปกได้",
    errorGeneric: "อัปโหลดไม่สำเร็จ — ลองใหม่อีกครั้ง",
  },
} as const;
