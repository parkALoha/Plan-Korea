...
export const E5_COPY = {
  ...
  home: {
     ...
     *
     * ## 🔴 พออยู่บรรทัดเดียวกัน **ระยะห่างเลิกเป็นตัวแยก — เหลือขนาด/น้ำหนักอย่างเดียว**
     * ***สองชื่อขนาดเท่ากัน = สองแบรนด์ · ชื่อใหญ่กับชื่อเล็ก = ชื่อกับคำอ่าน***
     * ⇒ `luitrip` คง `text-base font-extrabold` · `ลุยทริป` เล็กกว่าและจางกว่า (ดูจุดเรียกใน `HomeScreen`)
     * · **ห้ามทำให้สองคำนี้ขนาดเท่ากัน** ไม่ว่าจะด้วยเหตุผลเรื่องความสมดุลใด ๆ
     *
