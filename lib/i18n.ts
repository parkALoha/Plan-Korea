...
export const E5_COPY = {
  ...
  home: {
    ...
    brand: "luitrip",
    /**
     * บรรทัดใต้ชื่อบนแถบหัว — 🔴 **พาชื่อไทยมาด้วย ไม่ใช่แค่คำอธิบาย** (ผู้ใช้สั่งเอง 4 ก.ย. 2026:
     * *"บางส่วนของเว็บ ควรมีคำว่า **ลุยทริป** เป็นภาษาไทยด้วย"* · P1 ยืนยันการสะกดกับผู้ใช้แล้ว)
     *
     * ## เส้นแบ่งที่ใช้ — **ตัวอักษรของโลโก้ กับ ตัวอักษรที่คนอ่านออกเสียง คนละหน้าที่**
     * ```
     * luitrip   เวิร์ดมาร์ก · แท็บเบราว์เซอร์ · ชื่อบนโฮมสกรีน  → ต้องตรงกับตัวอักษร *บนโลโก้*
     * ลุยทริป    ข้อความไทยที่ *พูดถึง* แบรนด์                  → ที่ที่แบรนด์ถูกอ่านออกเสียง
     * ```
     * 🔴 **ทางที่ปฏิเสธ: ขึ้นบรรทัดที่สองเป็น `ลุยทริป` แยก** — แถบหัวมีสองบรรทัดอยู่แล้ว
     * บรรทัดที่สามทำให้แถบสูงขึ้นบนมือถือ **ซึ่งเป็นที่ที่แพงที่สุด** · เอามารวมบรรทัดเดียวได้ชื่อครบโดยไม่โต
     * ⚠️ **และห้ามวางทั้ง `luitrip` กับ `ลุยทริป` ใหญ่เท่ากันในที่เดียว** — จะอ่านเหมือนคนละแบรนด์
     *    ที่นี่ปลอดภัยเพราะ **ขนาดต่างกันชัด** (`text-base font-extrabold` เทียบ `text-2xs`)
     *
     * 🔴 **ห้าม find-replace คำว่า "ทริป" ทั้งไฟล์เด็ดขาด** — `upcomingTrips` ข้างล่างเป็น *คำไทยธรรมดา*
     *    และตอนนี้อันตรายกว่าเดิม เพราะคำแทนที่เป็นภาษาไทยด้วยกัน ⇒ ผลลัพธ์จะ **อ่านลื่นและผิด**
     *    (`"ลุยทริปที่จะมาถึง"` ไม่สะดุดตาเหมือน `"luitripที่จะมาถึง"` — ไม่มีเครื่องมือไหนจับได้)
     */
    brandTagline: "ลุยทริป · วางแผนทริปร่วมกัน",
