...
export const E5_COPY = {
   ...
   */
  explorer: {
    heading: "เริ่มจากปลายทาง",
    subheading: "เลือกประเทศแล้วเลือกเมือง — วันที่ค่อยใส่เองในขั้นถัดไป",
  ...
  home: {
    /** ชื่อผลิตภัณฑ์บนแถบหัว — **เป็นกลาง ไม่ผูกประเทศ** (เหตุผลเดียวกับ `app/layout.tsx`) */
    brand: "แพลนทริป",
