...
export const TEST_COUNTRY_CODES = {
  ...
  tripDestinations: "xp",
  /**
   * 🔴 **`E4` — เคสค้นเมืองปลายทางปลูก fixture ของตัวเอง ไม่พึ่งของที่รอบก่อนทิ้งไว้**
   *
   * ก่อน 3 ก.ย. 2026 เคสนั้นอาศัยเมืองที่ไฟล์อื่นทิ้งค้างในคลัง
   * · **และคอมเมนต์ในเคสเองทำนายไว้แล้ว**: *"ถ้าวันหนึ่ง fixture ถูกกวาดหมด เคสนี้จะเตือน"*
   * · แล้วมันเกิดจริงทันทีที่ `catalogFixtureSweep` เริ่มกวาดตอนจบรอบ
