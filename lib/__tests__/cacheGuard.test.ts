...
/**
 * 🔴 **`E6-AC7` เกณฑ์ขั้นต่ำ — *"เลิกกลืน error เงียบ"*** (ตั้งชื่อ AC ไว้ 28 ส.ค. 2026 · P3)
 * ค้นด้วยชื่อ AC แล้วต้องเจอด่านของมัน — ไม่งั้นด่านที่มีอยู่จริงจะถูกอ่านว่าไม่มี
 *
 * ⚠️ **ครอบเท่าที่มันครอบ ไม่มากกว่านั้น:** ถ้อยคำของ `AC7` เขียนว่า *"ต้องมีอะไร**บอกผู้ใช้**ว่าแคชเต็ม"*
 * ด่านนี้ตรึง `console.error` ซึ่งบอก **นักพัฒนา** ไม่ใช่ผู้ใช้ → **ยังไม่ปิดถ้อยคำเต็มของ `AC7`**
 */
