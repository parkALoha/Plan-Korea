 ...
 *   ถ้าเซิร์ฟเวอร์นับจากลิสต์เต็ม → **แทรกผิดตำแหน่งแบบเงียบ**
 ...
 * ⚠️ P1 ระบุว่า `stopRanksInDay` **ยังไม่ได้พิสูจน์ด้วยการรัน** — ส่งเคสขอบให้ P4 แล้ว
 *    (แทรกท้ายสุดเมื่อมี event `after` · วันที่ไม่มีจุดแวะเลย · วันที่มีแต่ event) **ยังไม่ปิด**
 */
