 ...
 *
 * 🔴 **ถ้าตัวอุ่นใช้เส้นเดียวกับ TTL ระบบจะแดงเป็นช่วง ๆ ตลอดไป:**
 * ```
 * แถวทั้ง 174 ใบถูกอุ่นวันเดียวกัน  →  หมดอายุพร้อมกันในวันเดียวกัน
 * heartbeat เพดาน MISSING_DETAILS=0 →  แดงทันทีที่นาฬิกาข้าม 30 วัน
 * ตัวอุ่นไล่ตามด้วย limit ต่อรอบ     →  **แดงค้างจนกว่าจะไล่ครบ**
 * ```
 * 🎯 ***ไม่มีใครทำอะไรผิดสักขั้น และมันจะเกิดทุก 30 วัน*** — เป็นคุณสมบัติของ
 *    การที่ของทั้งกองถูกสร้างพร้อมกัน ไม่ใช่ของบั๊ก
 *
